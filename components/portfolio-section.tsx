        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-between max-w-xs">
              <ProjectMetric label="Performance" value={projects[activeProject].metrics.performance} />
              <ProjectMetric label="Accessibility" value={projects[activeProject].metrics.accessibility} />
