  ...
  const capabilities = [
    {
      ...
      description: "We leverage a curated network of specialists to scale and adapt to each project's unique needs, ensuring the right expertise at the right time.",
      metrics: [
    ...
    },
    {
      ...
      description: "Our flexible approach allows us to scale teams up or down based on project requirements, maintaining efficiency without compromising quality.",
      metrics: [
    ...
    },
    {
      ...
      title: "Global Reach",
      description: "With a distributed model, we bring together the best talent regardless of location, offering round-the-clock development and support.",
      metrics: [
