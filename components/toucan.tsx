...
const polygons = [
  ...
  {
    id: 1,
    clipPath: 'polygon(35% 30%, 65% 30%, 65% 65%, 35% 65%)',
    color: 'var(--megaman)',
    translateZ: '25px',
    animationDelay: 0,
  },
  {
    id: 2,
    clipPath: 'polygon(33% 32%, 67% 32%, 67% 63%, 33% 63%)',
  ...
  {
    id: 3,
    clipPath: 'polygon(40% 25%, 60% 25%, 65% 35%, 35% 35%)',
    color: 'var(--megaman)',
    translateZ: '28px',
    animationDelay: 0.2,
  },
  ...
  {
    id: 4,
    clipPath: 'polygon(63% 33%, 95% 30%, 98% 38%, 63% 43%)',
    color: 'var(--electric-lettuce)',
    translateZ: '30px',
    animationDelay: 0.3,
  },
  {
    id: 5,
    clipPath: 'polygon(63% 43%, 98% 38%, 96% 46%, 63% 48%)',
    color: 'var(--lime-lightning)',
    translateZ: '32px',
    animationDelay: 0.4,
  },
  ...
  {
    id: 'smile-1',
    clipPath: 'polygon(75% 40%, 85% 40%, 83% 42%, 75% 42%)',
    color: '#FFFFFF',
    translateZ: '33px',
    animationDelay: 0.35,
  },
  {
    id: 'smile-2',
    clipPath: 'polygon(85% 40%, 90% 39%, 88% 41%, 83% 42%)',
    color: '#FFFFFF',
    translateZ: '33px',
    animationDelay: 0.35,
  },
...
export const Toucan = ({ className = '', scale = 0.6, enableEyeTracking = true }: ToucanProps) => {
  ...
  `}
    ...
    >
      ...
      <div
        ref={toucanRef}
        className="relative w-full h-full transform-gpu transition-none"
        style={{ transformStyle: 'preserve-3d' }}
      >
        {polygons.map((polygon) => (
          <div
