...
import { Check, ArrowRight, Zap, Leaf, BarChart, Shield, Globe, Code } from 'lucide-react';
    ...
    <section className="w-full max-w-7xl mx-auto px-4 py-24 relative">
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6 text-white">Investment Plans</h2>
            ...
            >
              ...
              <div className="relative h-full bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div
                    className={`p-3 rounded-xl ${pkg.highlighted ? 'bg-white/20' : 'bg-white/10'}`}
                  >
                    {pkg.icon}
                  </div>
                </div>
                ...
                {/* CTA Button */}
                <button
                  className={`w-full py-4 rounded-xl transition-all duration-300 group
                  ${
                    pkg.highlighted
        ...
        <div className="mt-16 text-center">
          <p className="text-white/60">
            All plans include our signature nature-inspired design philosophy and commitment to
            quality.
          </p>
          <p className="text-white/80 mt-2">
            Need a custom solution?{' '}
            <button className="text-[var(--frozen-turquoise)] hover:underline">Let's talk</button>
          </p>
        </div>
      </div>
    </section>
