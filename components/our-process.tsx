  ...
  const steps = [
    {
      ...
      duration: '1-4 Weeks',
      description:
        'Understanding your vision, goals, and technical requirements through in-depth consultation and planning.',
      details: [
    ...
    },
    {
      ...
      duration: '2-8 Weeks',
      description:
        'Creating detailed blueprints and visual designs that align with your brand and objectives.',
      details: [
        'UI/UX Design',
    ...
    },
    {
      ...
      duration: '4-16 Weeks',
      description:
        'Bringing your vision to life with clean, efficient code and stunning visualizations.',
      details: [
              ...
              >
                ...
                >
                  <div
                    ...
                    ${activeStep >= index ? 'text-white' : 'text-gray-500 dark:text-white/60'}`}
                  >
                    {step.icon}
                  </div>
                </button>
                ...
                >
                  ...
                  <p className={`text-sm mb-4 text-gray-500 dark:text-white/60`}>{step.duration}</p>
                  <p className={`mb-6 text-gray-600 dark:text-white/80`}>{step.description}</p>

                  <div
                    className={`space-y-3 text-left transition-all duration-500 max-h-0 overflow-hidden
                    ${activeStep === index ? 'max-h-[200px]' : ''}`}
                  >
                    {step.details.map((detail, dIndex) => (
                      <div
                        key={dIndex}
                        className={`flex items-center text-sm text-gray-500 dark:text-white/60`}
                      >
