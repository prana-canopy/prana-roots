    ...
    <main className="flex min-h-screen flex-col items-center justify-center relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10" aria-hidden="true">
        {mounted && (
          <>
            <div
              className={`absolute inset-0 ${theme === 'dark' ? 'gradient-1-dark' : 'gradient-1-light'}`}
            />
            <div
              className={`absolute inset-0 ${theme === 'dark' ? 'gradient-2-dark' : 'gradient-2-light'}`}
            />
